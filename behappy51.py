...
def banner():
    ...
    runntxt(WW+"   ..................  how are you friends")
    runntxt(WW+"     ....       Be_Happy")
    runntxt(GL+"                   keep smiling")
    runntxt(GG+"     ..........     best of luck")
    ...
    print GG+"  √=============================================√"
    print WW+"  |            Creat by BE_HAPPY             |"
    print GL+"  |                 KEEP SMILING       |"
    print WW+"  |        TEAM : PAKISTAN HACKERS            |"
    print Y+"  |             INSTAGRAM: NO CREAT ACCOUNT              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ L.O.P ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   PAKISTAN HACKERS^_^   •••••••••|"
    print GG+"  √=============================================√"
